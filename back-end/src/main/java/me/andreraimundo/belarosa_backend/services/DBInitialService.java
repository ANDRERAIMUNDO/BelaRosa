...
//OBS: User esta base de dados para testa o sistema
@Service
public class DBInitialService {
    ...
    public void instantiateTestDataBase () throws ParseException {
		...
		Registro reg1 = new Registro (null, "andrefake1@gmail.com", pe.encode("1402"));
		reg1.addPerfil(Perfil.ADMIN); 
		Registro reg2 = new Registro (null, "andrefake2@gmail.com", pe.encode("1402"));
		Registro reg3 = new Registro (null, "andrefake3@gmail.com", pe.encode("1402"));
		reg3.addPerfil(Perfil.ADMIN);
		Registro reg4 = new Registro (null, "andrefake4@gmail.com", pe.encode("1402"));
		reg4.addPerfil(Perfil.ADMIN);
		Registro reg5 = new Registro (null, "andrefake5@gmail.com", pe.encode("1402"));
		reg5.addPerfil(Perfil.ADMIN);
		Registro reg6 = new Registro (null, "test_user_44554176@testuser.com", pe.encode("qatest5398")); //usuario de teste do mercado pago
		Registro reg7 = new Registro (null, "andrefake7@hotmail.com", pe.encode("1402"));
		
		Cliente cl1 = new Cliente(reg1, null, "ndre Fake User1", "86773894077", "24061993", "91984001327");
		Cliente cl2 = new Cliente(reg2, null, "Andre Fake User2", "63079207009", "30111991", "91984366580");
		Cliente cl3 = new Cliente(reg3, null, "Andre Fake User3", "29167241093", "10031991", "91999001422");
		Cliente cl4 = new Cliente(reg4, null, "Andre Fake User4", "01011990","82640149253", "91999132862");
		Cliente cl5 = new Cliente(reg5, null, "Andre Fake User", "63079207009", "13122009", "91988646337");
		Cliente cl6 = new Cliente(reg6, null, "TESTV6SUUCNO", "11111111111", "30/11/1998", "91985321472");
		Cliente cl7 = new Cliente(reg7, null, "Andre Fake User", "22501422031", "30/11/1998", "9198435672");
		...
		Endereco end1 = new Endereco(null, "68655000", "Rua 1","20", "Comercio", "Centro", "Belém", "PA",reg1, cl1);
		Endereco end2 = new Endereco(null, "68655000", "Rua 2", "38", "centro", "Vila Nova", "Belém", "PA",reg2, cl2);
		Endereco end3 = new Endereco(null, "68655000", "Rua 3", "34", "centro","Vila Nova", "Belém", "PA",reg3, cl3);
		Endereco end4 = new Endereco(null, "68655000", "Rua 4", "38", "centro","Vila Nova", "Belém", "PA",reg4, cl4);
		Endereco end5 = new Endereco(null, "68655000", "Rua 5", "38", "centro", "Vila Nova", "Belém", "PA",reg5, cl5);
		Endereco end6 = new Endereco(null, "68655000", "Rua 6","20", "Comercio", "Centro", "Belém", "PA",reg6, cl6);
		Endereco end7 = new Endereco(null, "68655000", "Rua 7","20", "Comercio", "Centro", "Belém", "PA",reg7, cl7);
