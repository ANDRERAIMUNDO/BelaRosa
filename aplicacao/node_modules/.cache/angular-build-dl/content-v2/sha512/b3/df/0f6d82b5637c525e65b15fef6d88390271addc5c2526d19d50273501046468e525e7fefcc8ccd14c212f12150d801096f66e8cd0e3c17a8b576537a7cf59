  ...
  (self["webpackChunkbelarosa"] = self["webpackChunkbelarosa"] || []).push([["src_app_pages_login_login_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _LoginPage = /*#__PURE__*/function () {
        function LoginPage(router, authService, loadingController) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function refresh() {
            ...
            this.authService.refreshToken().subscribe(function (response) {
              _this.authService.sucessLogin(response.headers.get('Authorization'));
          ...
          value: function login() {
            ...
            this.button = true;
            this.sniper = "ok";
            this.authService.authetocation(this.credenciais).subscribe(function (response) {
              _this2.button = true;
              _this2.sniper = "ok";

              _this2.authService.sucessLogin(response.headers.get('Authorization'));

              _this2.router.navigate(['/dashboard/index']);
            }, function (catchError) {
              //if (catchError.status == 401)
              //    {
              _this2.erroLogin = "erro";
              _this2.button = false;
              _this2.sniper = null; //  }
            });
          }
